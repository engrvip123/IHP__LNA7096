...
C {vsource.sym} 2500 -950 0 0 {name=V4 value=1.2}
C {gnd.sym} 2500 -920 0 0 {name=l11 lab=GND}
C {lab_wire.sym} 2500 -1060 0 0 {name=p9 sig_type=std_logic lab=vdd
}
C {devices/code_shown.sym} 1292.8125 -1427.34375 0 0 {name=NGSPICE
only_toplevel=true
value="
...
.include /home/ic_design_trg/lna_ihp/xschem/01_lna/simulation/LNA_with_buff_tb.save
...
write LNA_with_buff_tb.raw all 
*write LNA_with_buff_tb.raw S_1_1 S_2_1 S_1_2 S_2_2 s11 s21 s12 s22 mag_s21 NF NFmin Rn SOpt
.endc
" }
C {devices/launcher.sym} 2650 -1410 0 0 {name=h5
descr="load SP curves" 
tclcommand="xschem raw_read $netlist_dir/LNA_with_buff_tb.raw ac"
}
...
C {ammeter.sym} 2500 -1010 2 0 {name=Vmeas savecurrent=true spice_ignore=0}
C {01_lna/LNA_with_buff_rlc.sym} 2450 -790 0 0 {name=x1}
